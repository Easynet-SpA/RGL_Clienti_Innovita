...
<Assembly: AssemblyTitle("Innovita")>
<Assembly: AssemblyDescription("Innovita")>
<Assembly: AssemblyCompany("Rgl Informatica")>
<Assembly: AssemblyProduct("Innovita")>
<Assembly: AssemblyCopyright("Rgl Informatica")>
<Assembly: AssemblyTrademark("Rgl Informatica")>
<Assembly: CLSCompliant(True)> 

'Se il progetto viene esposto a COM, il GUID che segue verr� utilizzato per creare l'ID della libreria dei tipi.
<Assembly: Guid("48F6A539-E110-4AA2-8CF7-E98E55E2F4F9")>
